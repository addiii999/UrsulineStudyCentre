...
import { Search, MessageSquare, CheckCircle, PhoneCall, XCircle } from "lucide-react";
...
const SAMPLE_ENQUIRIES: Enquiry[] = [
  { id: "1", name: "Riya Sharma", phone: "9507589503", class: "Class 11", stream: "PCM", message: "Interested in JEE coaching", status: "new", created_at: "2026-05-03" },
  { id: "2", name: "Priya Gupta", phone: "9876543210", class: "Class 9", stream: "", message: "Enquiring about batch timings", status: "contacted", created_at: "2026-05-02" },
  { id: "3", name: "Anjali Singh", phone: "8765432109", class: "Class 12", stream: "PCB", message: "NEET preparation inquiry", status: "admitted", created_at: "2026-05-01" },
  { id: "4", name: "Kavya Verma", phone: "7654321098", class: "Class 10", stream: "", message: "", status: "new", created_at: "2026-05-02" },
  { id: "5", name: "Simran Mehta", phone: "6543210987", class: "Class 11", stream: "Commerce", message: "Fee structure query", status: "rejected", created_at: "2026-04-30" },
];
